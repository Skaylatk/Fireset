...
void fsDrawSprite(const FsSprite* sprite, int zindex){
    ...
    glPushMatrix();
        ...
        switch(sprite->texRot % 4){
            case 0: rotIdx[0]=0; rotIdx[1]=1; rotIdx[2]=2; rotIdx[3]=3; break;
            case 1: rotIdx[0]=3; rotIdx[1]=0; rotIdx[2]=1; rotIdx[3]=2; break;
            case 2: rotIdx[0]=2; rotIdx[1]=3; rotIdx[2]=0; rotIdx[3]=1; break;
            case 3: rotIdx[0]=1; rotIdx[1]=2; rotIdx[2]=3; rotIdx[3]=0; break;
        }
        ...
        glBegin(GL_QUADS);
            for(int i=0; i<4; i++){
                ...
                switch(i){
                    case 0: glVertex3f(-0.5f,-0.5f,0.0f); break;
                    case 1: glVertex3f(0.5f,-0.5f,0.0f); break;
                    case 2: glVertex3f(0.5f,0.5f,0.0f); break;
                    case 3: glVertex3f(-0.5f,0.5f,0.0f); break;
                }
            }
        glEnd();
